...
# Tab layout
tab1, tab2, tab3, tab4 = st.tabs(["📊 Strike Details", "🔥 OI Heatmap", "🧠 Max Pain & PCR", "🔍 PCR Snapshot Compare"])
...
with tab4:
    st.markdown("### 📊 PCR Analysis & Trend Detection")
    ...
    with colA:
        if st.button("💾 Save PCR Snapshot (Manual)", key="save_pcr_manual"):
